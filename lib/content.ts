...
export const PACKAGES: Package[] = [
  {
    ...
    price: "Free",
    originalPrice: "£300 setup",
    timeline: "14-day free trial — no card needed",
    ...
    features: [
      ...
      "Replies in your voice — warm, personal, on-brand",
      "Handles 5-star praise and complaints equally well",
      "Telegram alert — approve and post in one tap",
      "Runs 24/7 with no manual work from you",
    ],
    guarantee: "14-day free trial. Cancel before it ends — pay nothing.",
    highlight: false,
  ...
  },
  {
    ...
    price: "£55",
    originalPrice: "£75",
    timeline: "per month — setup included, cancel anytime",
    ...
    features: [
      ...
      "Inbox drops from 90 min to under 15 min a day",
      "Urgent emails pinged to your phone instantly",
      "Bookings, complaints, suppliers all handled",
      "Everything logged to a live Google Sheet",
      "Priority support included",
    ],
    valueStack: [
      { item: "Reputation Manager", value: "£45/mo" },
      { item: "Inbox Autopilot", value: "£45/mo" },
      { item: "Priority support", value: "£30/mo" },
    ],
    guarantee: "If it does not save you 15 min a day — full refund, no questions.",
    scarcity: "5 onboarding spots left this month",
    badge: "BEST VALUE",
    highlight: true,
    cta: "Get started — £55/mo",
  },
  {
    ...
    features: [
      ...
      "Drafts replies in your tone automatically",
      "Urgent items pinged to your phone instantly",
      "Bookings, complaints, suppliers all handled",
