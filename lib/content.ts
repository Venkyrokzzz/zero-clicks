...
export const PACKAGES: Package[] = [
  ...
  {
    name: "Full Autopilot",
    tagline: "Built for your pub. Runs itself.",
    price: "£120",
    timeline: "per month · £350 one-time setup",
    description: "A fully custom AI agent built around your pub — your voice, your rules, your alerts. Not a template. Not a one-size-fits-all tool. Yours.",
    features: [
      "Everything in Reputation Manager",
      "Custom AI agent trained on your pub's voice and tone",
      "Custom reply rules — you decide what gets auto-sent vs flagged",
      "WhatsApp alerts configured to your exact thresholds",
      "Monthly insights report — ratings, trends, what guests say most",
      "Priority support + quarterly tune-up included",
    ],
    valueStack: [
      { item: "Reputation Manager", value: "£75/mo" },
      { item: "Custom agent build", value: "£50/mo" },
      { item: "Monthly insights", value: "£30/mo" },
    ],
    highlight: false,
    cta: "Book a call",
  },
