...
export const PACKAGES: Package[] = [
  {
    ...
    tagline: "We build it for you, free. Pay nothing until it's live.",
    price: "£35",
    originalPrice: "£55",
    timeline: "per month · £0 setup · price locked for life",
    description: "We set up your entire AI system by hand — and you don't pay a penny until it's live and replying to your real reviews.",
    features: [
      "We build & connect everything for you — £0 setup (normally £499)",
      "Pay nothing until it's live and replying to real reviews",
      "£35/mo locked in for life — never increases",
      "AI trained in your pub's voice, not a template",
      "Direct access to Venky for onboarding",
    ],
    guarantee: "£0 until it's live & working",
